import { unregisterConversionStrategy as i, registerConversionStrategy as c } from "textmode.js";
const l = "accurate";
let r = null;
const s = { id: l, createShader: () => r, createUniforms({ source: e, font: n, gridWidth: a, gridHeight: t }) {
  const o = e.createBaseConversionUniforms();
  return Object.assign(o, { u_characterTexture: n.fontFramebuffer, u_charsetDimensions: [n.textureColumns, n.textureRows], u_imageCellDimensions: [a, t], u_sampleGridSize: n.fontSize }), o;
} }, u = () => ({ name: "textmode.accurate", version: "1.0.0", async install(e) {
  r = await e.createFilterShader(`#version 300 es\r
...
`), c(s);
  ...
  i(l), r && (r.dispose(), r = null);
} });
typeof window < "u" && (window.createAccurateConversionPlugin = u);
export {
  u as createAccurateConversionPlugin
};
