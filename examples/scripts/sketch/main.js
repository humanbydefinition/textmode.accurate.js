...
import * as accurateModule from 'textmode.accurate.js';
...
if (!examplePath || !isValidPath(examplePath)) {
	...
	window.AccurateConversionPlugin = accurateModule.AccurateConversionPlugin;

	document.title = `textmode.accurate.js - ${examplePath}`;
